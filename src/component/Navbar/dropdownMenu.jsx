...
const DropdownMenu = ({
  ...
  const dropdownClasses = {
    normal: "absolute top-full mt-3 left-1/2 transform -translate-x-1/2 w-[18rem] z-50",
    "full-width": "absolute top-full left-[2rem] right-[2rem] flex justify-center py-6 z-50"
  };
