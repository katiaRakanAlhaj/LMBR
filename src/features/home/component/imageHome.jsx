                    ...
                    {sliderData?.data?.map((item, index) => (
                        <SwiperSlide key={index}>
                            ...
                            <div className="relative w-full h-full">
                                ...
                                {/* Description Container - Always Visible */}
                                <div className="absolute inset-0 flex items-end justify-center pb-8 lg:pb-[14rem]">
                                    {/* Content Container */}
                                    <div className="relative z-10 w-full max-w-2xl px-4 mx-auto">
                                        <div className="p-6 lg:p-8">
                                            <p className="text-[#E7792D] font-bold lg:text-[2rem] text-[1.3rem]  text-center leading-relaxed mb-4">
                                                {item.title}
                                            </p>
                                            <p 
                                                ...
                                                className="text-white text-base md:text-lg  lg:text-[1.2rem] text-center leading-relaxed" 
                                            />
                                        </div>
                                    </div>
                                </div>
